...
public class UpdateInventoryItem extends AppCompatActivity {
    ...
    private void addInventoryItem() {
        ...
        String _id = dbManager.getInventoryItem(itemName.getText().toString())[0];
        if(_id != null) {
            dbManager.update(Long.parseLong(_id),itemName.getText().toString(), quantity.getText().toString());
        }
        else {
